...
def main(argv: Sequence[str]) -> int:
    ...
    out_md = out_dir / f"pattern_engine_report_{period_id}_{BUILDER_VERSION}.md"
    out_data = out_dir / f"pattern_engine_report_{period_id}_{BUILDER_VERSION}_data.json"
    out_pdf = out_dir / f"pattern_engine_report_{period_id}_{BUILDER_VERSION}.pdf"
