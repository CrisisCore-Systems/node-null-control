...
| Webhook URL | `https://hook.make.com/[webhook-id]` (generated by Make when you create the Tally trigger module) |
...
This lets the buyer add the call during checkout (toggle 0→1) without adding form complexity.
